                                ...
                                >
                                  ...
                                  >
                                    <tr v-for="day in week" :key="day.id">
                                      ...
                                      >
                                        <SwitchToggle v-model="day.toggle" />
                                      </td>
                                    </tr>
                                  </tbody>
                                </table>
...
export default {
  ...
  mounted() {
    this.$axios
      .get(this.$store.state.baseUrl + '/availabilities', {})
      .then((result) => {
        const avalabilities = result.data
        for (let i = 0; i < avalabilities.length; i++) {
          const ab = avalabilities[i]
          const obj = {
            name: ab.name,
            id: ab.id,
            toggle: true,
  ...
  methods: {
    ...
    registerUser() {
      ...
      const avalabilities = this.week
      this.$axios
        .post(this.$store.state.baseUrl + '/signup', {
          user,
          avalabilities,
        })
        .then(() => {
